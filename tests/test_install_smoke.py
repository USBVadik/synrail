...
class InstallSmokeTests(unittest.TestCase):
    ...
    def test_first_run_guide_mentions_preflight_and_git_missing_path(self) -> None:
        ...
        self.assertIn("## Known Gap: Behavioral Claims Are Not Re-Executed Yet", public_readme)
        self.assertIn("It does not re-run\ntest suites.", public_readme)
        self.assertIn("can still reach `Status: Accepted` while the real tests fail.", public_readme)
