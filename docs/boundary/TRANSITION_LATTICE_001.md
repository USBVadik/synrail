...
The current lattice is anchored by four transition families:
...
- accepted to degraded is stronger than degraded back to accepted
...
2. add a missing reverse or recovery transition with real enforcement
