...
- one fifth uglier packet-first continuation that now crosses invalid proof, recovery repair, doctor target-identity pressure, and accepted closure through named `resume`
