...
Define the first executable doctor slice for `Synrail`.
...
The first doctor slice now lives at:

- `tools/reference/synrail_doctor_v0.py`
...
The executable v0 doctor currently evaluates:
...
The doctor currently does not perform:

- automatic environment probing
- helper contamination discovery
