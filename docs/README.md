...
- `../fixtures/alpha_shell_run_003/shell/check_stdout.txt`
- `../fixtures/alpha_shell_run_003/lane/project_profile.json`
- `../fixtures/alpha_shell_run_003/lane/thin_output.json`
- `../fixtures/alpha_shell_run_003/lane/prompt.json`
- `../fixtures/alpha_shell_run_003/lane/followup.json`
- `../fixtures/alpha_shell_run_003/shell/continue_stdout.txt`
- `../fixtures/alpha_onboarding_run_003/shell/next_step_before_check_stdout.txt`
- `../fixtures/alpha_onboarding_run_003/shell/restore_without_checkpoint_stdout.txt`
- `../fixtures/alpha_onboarding_run_003/shell/checkpoint_verify_without_checkpoint_stdout.txt`
