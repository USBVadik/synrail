...
- `../fixtures/alpha_shell_run_002/shell/check_stdout.txt`
- `../fixtures/alpha_shell_run_002/lane/project_profile.json`
- `../fixtures/alpha_shell_run_002/lane/thin_output.json`
- `../fixtures/alpha_shell_run_002/lane/prompt.json`
- `../fixtures/alpha_shell_run_002/lane/followup.json`
- `../fixtures/alpha_onboarding_run_002/shell/next_step_before_check_stdout.txt`
- `../fixtures/alpha_onboarding_run_002/shell/restore_without_checkpoint_stdout.txt`
- `../fixtures/alpha_onboarding_run_002/shell/checkpoint_verify_without_checkpoint_stdout.txt`
- `../fixtures/thin_output_run_accepted_002/thin_output.json`
