...
- `../fixtures/alpha_shell_run_004/shell/check_stdout.txt`
- `../fixtures/alpha_shell_run_004/lane/project_profile.json`
- `../fixtures/alpha_shell_run_004/lane/thin_output.json`
- `../fixtures/alpha_shell_run_004/lane/prompt.json`
- `../fixtures/alpha_shell_run_004/lane/followup.json`
- `../fixtures/alpha_shell_run_004/shell/continue_stdout.txt`
- `../fixtures/alpha_onboarding_run_004/shell/next_step_before_check_stdout.txt`
- `../fixtures/alpha_onboarding_run_004/shell/restore_without_checkpoint_stdout.txt`
- `../fixtures/alpha_onboarding_run_004/shell/checkpoint_verify_without_checkpoint_stdout.txt`
