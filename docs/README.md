...
- `core/ARTIFACT_CONSISTENCY_RUN_004.md`
- `core/ARTIFACT_CONSISTENCY_RECOVERY_001.md`
...
- `core/THIN_OUTPUT_CONSISTENCY_RECOVERY_001.md`
- `core/PROMPT_BRIDGE_001.md`
- `core/PROMPT_FOLLOWUP_TEST_001.md`
- `core/PROMPT_RETRY_GUARD_001.md`
- `core/CONSISTENCY_RECOVERY_PROMPT_001.md`
...
- `core/OPERATOR_RENDER_001.md`
- `core/OPERATOR_READING_TEST_001.md`
- `core/OPERATOR_READING_TEST_002.md`
...
- `schemas/resume_input_overrides_v0.schema.json`
...
- `../fixtures/second_operator_test_006/second_operator.json`
...
- `../fixtures/alpha_shell_run_005/shell/check_stdout.txt`
- `../fixtures/alpha_shell_run_005/lane/project_profile.json`
- `../fixtures/alpha_shell_run_005/lane/thin_output.json`
- `../fixtures/alpha_shell_run_005/lane/prompt.json`
- `../fixtures/alpha_shell_run_005/lane/followup.json`
- `../fixtures/alpha_shell_run_005/shell/continue_stdout.txt`
- `../fixtures/alpha_onboarding_run_005/shell/next_step_before_check_stdout.txt`
- `../fixtures/alpha_onboarding_run_005/shell/restore_without_checkpoint_stdout.txt`
- `../fixtures/alpha_onboarding_run_005/shell/checkpoint_verify_without_checkpoint_stdout.txt`
- `../fixtures/thin_output_continue_run_002/thin_output.json`
- `../fixtures/thin_output_run_accepted_003/thin_output.json`
