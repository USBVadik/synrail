...
### Secondary blocked-retry shell contour
...
```bash
python3 tools/reference/synrail_validate_v0.py --schema schemas/thin_output_record_v0.schema.json --document fixtures/alpha_test_pack_run_004/lane/thin_output.json
python3 tools/reference/synrail_validate_v0.py --schema schemas/repair_prompt_bridge_record_v0.schema.json --document fixtures/alpha_test_pack_run_004/lane/prompt.json
python3 tools/reference/synrail_validate_v0.py --schema schemas/alpha_session_replay_record_v0.schema.json --document fixtures/alpha_test_pack_run_004/lane/telemetry/session_replay.json
```
